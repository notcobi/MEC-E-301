...
\fancyhead[C]{Lab 4: Strain Gauges} % Center header
...
\begin{titlepage}
    ...
    % Date
    \Large Date: November 7, 2023 \\ % or manually specify a date
...
\setlength{\belowdisplayskip}{7pt} \setlength{\belowdisplayshortskip}{0pt}
